...
export default function UpdateStudent() {
    ...
    // Assuming you receive the ID of the student you want to update from props or query params
    const studentIdToUpdate = ''; // Set the ID of the student you want to update here
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            // Assuming you have an API endpoint for updating a student with a specific ID
            const response = await axios.put(`/api/updateStudent/${studentIdToUpdate}`, formData, {
                headers: {
    ...
    return (
        <Layout>
            <div className="container-fluid">
                <h3 className="mt-2">Update Student</h3>
                <hr />
                <div className="card mt-4 p-4 border-0" style={{ boxShadow: "rgba(50, 50, 93, 0.25) 0px 50px 100px -20px, rgba(0, 0, 0, 0.3) 0px 30px 60px -30px, rgba(10, 37, 64, 0.35) 0px -2px 6px 0px inset" }}>
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="d-grid gap-2 d-md-flex justify-content-md-end">
                            ...
                            <button type="submit" className="btn btn-primary me-md-2">Update Student</button>
                        </div>
                    </form>
                </div>
            </div>
